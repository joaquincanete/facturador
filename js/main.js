...
(function() {
  (function($) {
    var actualizaTotales, addArticulo, anular, cambiarLista, clearForm, deleteRow, getArticulo, getCliente, getClientes, imprimir, procesarStocks, setCantidad;
    numeral.language('es', {
      delimiters: {
        thousands: '.',
        decimal: ','
